...
public abstract class Asset implements Serializable {
  ...
  /**
   * Funktion die Alle daten die für die Suche wichtig sind
   * eines Assets in einem String zusammenführt
   *
   * @return alle daten in einem String
   */
  public abstract String concatData();
  /**
